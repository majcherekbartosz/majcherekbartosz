      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-14 items-start">
        ...
        <div className="lg:col-span-2">
          <div className="sticky top-24">
            ...
            <p className="text-center text-xs text-gray-400 mt-3 font-serif italic">
        ...
        <div className="lg:col-span-3">
          ...
          <div className="space-y-6 text-gray-600 leading-relaxed text-base sm:text-lg">
            ...
            <div className="bg-cream-50 border-l-4 border-terracotta-400 rounded-r-2xl px-6 py-5 my-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-95 bg-terracotta-500 hover:bg-terracotta-600 text-white"
                >
                  <BookOpen size={15} />
                  Kup E-booka
                </a>
          ...
          <div className="mt-14 pt-8 border-t border-cream-200">
            ...
            <div className="w-16 h-0.5 bg-terracotta-400 mt-3 rounded-full" />
          </div>
        </div>
      </div>
    </div>
